...
set_clock_groups -exclusive -group {twd_clk} -group {sys_clk} -group {tac_clk} -group {tdqss_clk} -group {core_clk}
...
create_clock -waveform {1.0101 1.6835} -period 1.3468 hdmi_rx_fast_clk
create_clock -waveform {1.0101 1.6835} -period 1.3468 hdmi_tx_fast_clk
create_clock -waveform {3.3670 6.7340} -period 6.7340 hdmi_rx_slow_clk
create_clock -period 3.3670 hdmi_rx_slow_clk_2x
set_false_path -from [get_clocks hdmi_rx_slow_clk] -to [get_clocks core_clk]
set_false_path -from [get_clocks hdmi_rx_slow_clk_2x] -to [get_clocks core_clk]
